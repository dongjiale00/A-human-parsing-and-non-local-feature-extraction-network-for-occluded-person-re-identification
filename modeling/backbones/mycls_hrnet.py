...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        # self.seg_f = 'part_t'
        # self.T = 4
        self.context_l4_1 = MSPyramidAttentionContextModule(in_channels=1920, out_channels=1920, c1=1920//2, c2=1920//2,
                                                            dropout=0, fusion="+", sizes=([1]),
                                                            if_gc=0)
        #self.SELayer = SEModule(channels=1920, reduction=16)
        #self.context_l4_2 = MSPyramidAttentionContextModule(in_channels=256, out_channels=256, c1=256//2, c2=256//2,
        #                                                    dropout=0, fusion="+", sizes=([1]),
        #                                                    if_gc=0)
